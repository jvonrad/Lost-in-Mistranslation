...
CHUNK_TOKENS = 4096      # long chunks for efficiency (try 2048/4096)
MAX_STEPS = 5000

OUTDIR = "/data/jonathan/Lost-in-Mistranslation/models/llama2-ted2025-cpt" + ("-tags" if USE_TAGS else "-notags")
