...
'''
python zett/data/prepare.py \
  --include_langs en de ar bn ru fr es ja zh sw id pt \
  --max_train_pages_per_language 100000
'''

METADATA_PATH = "zett/data/madlad400_metadata.csv"
...
class Args:
    ...
    out_train_dir: str = "/data/jonathan/Lost-in-Mistranslation/datasets/MADLAD-400/train"
    out_valid_dir: str = "/data/jonathan/Lost-in-Mistranslation/datasets/MADLAD-400/valid"
